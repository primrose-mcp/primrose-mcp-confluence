 ...
 *
 * Custom error classes and error handling helpers for Confluence API.
 */

/**
 * Base Confluence API error
 */
export class ConfluenceApiError extends Error {
  ...
  constructor(message: string, statusCode?: number, code?: string, retryable = false) {
    ...
    this.code = code || 'CONFLUENCE_ERROR';
 ...
 * Forbidden error
 */
export class ForbiddenError extends ConfluenceApiError {
  constructor(message: string) {
